...
public class BookDirectoryTestSuite {
    ...
    class BooksInHand {
        ...
        LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "416549472");
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> listOfBooksInHand = new ArrayList<>();

        @Test
        void listBooksInHandsOfUserWithoutBooks() {

            // Given
            bookLibrary.userBooksMap.put(libraryUser, listOfBooksInHand);

            //When
            List<Book> result = bookLibrary.listBooksInHandsOf(libraryUser);

            //Then
            assertEquals(listOfBooksInHand, result);
        }
        ...
        void listBooksInHandsOfUserWith1Book() {
            ...
            // Given
            listOfBooksInHand.add(new Book("Title", "Author", 2124));
            bookLibrary.userBooksMap.put(libraryUser, listOfBooksInHand);
        ...
        void listBooksInHandsOfUserWith5Books() {
            ...
            // Given
            listOfBooksInHand.add(new Book("Title1", "Author1", 2021));
            listOfBooksInHand.add(new Book("Title2", "Author2", 2032));
            listOfBooksInHand.add(new Book("Title3", "Author3", 2021));
            listOfBooksInHand.add(new Book("Title4", "Author4", 2064));
            listOfBooksInHand.add(new Book("Title5", "Author5", 2023));
            bookLibrary.userBooksMap.put(libraryUser, listOfBooksInHand);
